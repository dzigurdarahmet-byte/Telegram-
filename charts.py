...
TEXT_COLOR = "#ffffff"
TEXT_MUTED = "#9ba3b5"
COLOR_CURRENT = "#00b4ff"
COLOR_PREVIOUS = "#3a3f52"
COLOR_UP = "#00e676"
COLOR_DOWN = "#ff1744"
GRID_COLOR = "#1e2230"
...
def generate_yoy_chart(current: dict, previous: dict, label: str) -> io.BytesIO:
    ...
    for ax, (title, key) in zip(axes, metrics):
        ...
        # Яркая подсветка текущего столбца
        bars[1].set_edgecolor(COLOR_CURRENT)
        ...
        ax.text(
            ...
            bbox=dict(
                ...
                facecolor=pct_color + "25",
                edgecolor=pct_color + "80",
                linewidth=1.5,
            ),
        )
